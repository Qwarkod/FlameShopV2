...
endBuyButton.addEventListener('click', (e) => {
  ...
  window.location.href = `https://marble-toothsome-efraasia.glitch.me/?product=1&productName=Герлянда-Штора&Length=${lengthString}&Price=${selectedPrice}&Color=${colorString}`;
